...
big_matrix = [linspace(1, power_iter+1, (power_iter)/taubatchrange(1)+1)', conv_noise_norm(1:taubatchrange(1):end)', ...
    linspace(1, power_iter+1, (power_iter)/taubatchrange(1)+1)', conv_noise_mat(1:taubatchrange(1):end,1), ...
    [linspace(1, power_iter+1, (power_iter)/taubatchrange(2)+1),zeros(1,50)]', [conv_noise_mat(1:taubatchrange(2):end,2); zeros(1,50)'],...
    [linspace(1, power_iter+1, (power_iter)/taubatchrange(3)+1),zeros(1,75)]', [conv_noise_mat(1:taubatchrange(3):end,3); zeros(1,75)'],...
    [linspace(1, power_iter+1, (power_iter)/taubatchrange(4)+1),zeros(1,90)]', [conv_noise_mat(1:taubatchrange(4):end,4); zeros(1,90)']];